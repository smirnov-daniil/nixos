{
  flake.nixosModules.pipewire = _: {
    ...
    services.pipewire = {
      enable = true;
      # Without at least one of these, services.pipewire.audio.enable defaults
      # to false and PipeWire runs compositor-only: no ALSA devices, no
      # sources, just a Dummy Output.
      alsa.enable = true;
